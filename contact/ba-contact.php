...
<html class="no-js" lang="zxx">
    ...
    <body class="is-preload">
		...
		<ul class="pro-features">
			...
			<div class="button">
				<a href="#" target="_blank" class="btn">Join the Queue</a>
				<a href="#" target="_blank" class="btn">Request a Callback</a>
			</div>
		</ul>
		...
		<!-- Breadcrumbs -->
		<!-- <div class="ba-breadcrumbs">
            <div class="container">
					<div class="row">
                        <h1  class="centered-heading">Business Analyst</h1>
					</div>
				</div>
			</div>
		</div> -->
		...
		<section class="contact-us">
            <div class="training-inner">
                <div class="row"> 
                    <div class="col-lg-6 left-col-ba">
                        <div class="contact-us-left">
                            <div class="container">
                                <h1>Business Analyst</h1>    
        
                                <p>
                                    A four-month training program where trainees are assisted to register for certification exams within first week of course start date and prepared to write their professional exams by end of the training period. Trainees are placed on internship and work on live projects to get a hands-on experience as a Business Analyst.
                                </p>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group login-btn">
                                            <button class="btn" type="submit" id="btnContactUs">Send</button>
                                        </div>
                                        <!--div class="checkbox">
